...
// Wrapper for ServerSocket to implement ServerSocketBase<Socket>
class _ServerSocketWrapper implements ServerSocketBase<Socket> {
  final ServerSocket _socket;
  _ServerSocketWrapper(this._socket);
...
class _HttpServer extends Stream<HttpRequest>
  ...
  // Use default Map so we keep order.
      ...
      return _HttpServer._(_ServerSocketWrapper(socket), true);
    });
